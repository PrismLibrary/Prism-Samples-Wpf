...
namespace ModularityWithNinject.Desktop
{
    ...
    /// </summary>
    public class QuickStartBootstrapper : NinjectBootstrapper
    {
        ...
        /// <see cref=""/> will attach the default <seealso cref="Prism.Regions.IRegionManager"/> of
        ...
        /// <summary>
        /// Configures the <see cref="Prism.Ninject"/>. May be overwritten in a derived class to add specific
        /// type mappings required by the application.
        /// </summary>
        protected override void ConfigureKernel()
        {
            base.ConfigureKernel();
            this.Kernel.RegisterTypeIfMissing(typeof(IModuleTracker), typeof(ModuleTracker), true);
            this.Kernel.Bind<CallbackLogger>().ToConstant(this.callbackLogger);
        }
